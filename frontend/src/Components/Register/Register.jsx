...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8000/api/v1/users/register',dataToSend)
        ...
        <div className="min-h-screen w-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-6 sm:py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
            <div className="max-w-[95%] text-black w-full sm:max-w-md md:max-w-lg lg:max-w-xl mx-auto space-y-6 bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-lg">
                ...
                <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
                    ...
                    {/* Age and Date of Birth - Responsive Grid */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        {/* Date of Birth Field */}
                        <div className="space-y-1 sm:space-y-2">
                            <label htmlFor="dateOfBirth" className="block text-sm sm:text-base font-medium text-gray-700">
                                Date of Birth
                            </label>
                            <input
                                id="dateOfBirth"
                    ...
                    {/* About Field */}
                    <div className="space-y-1 sm:space-y-2">
                        <label htmlFor="about" className="block text-sm sm:text-base font-medium text-gray-700">
                            About
                        </label>
                        <textarea
                            id="about"
                        ...
                        <div className="flex justify-between items-center">
                            {errors.about && (
                                <p className="text-xs sm:text-sm text-red-600">{errors.about}</p>
                            )}
